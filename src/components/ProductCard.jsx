...
const ProductCard = () => {
  ...
  // Handle add to cart dengan animasi
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 mb-6">
          ...
          <div className="relative w-full md:w-96">
            ...
            <input
              ...
              className="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-full bg-white shadow-sm focus:outline-none focus:ring-pink-500 focus:border-pink-500"
              value={searchQuery}
        ...
        filteredProducts.length <
          ...
          <div className="text-center mt-8">
            <button
              ...
              className="px-6 py-2 bg-white border border-pink-500 text-pink-500 rounded-full hover:bg-pink-50 transition-colors"
            >
              Load More Products
            </button>
          </div>
